...
class localization(Node):
    ...
    def odom_and_pf_pose_callback(self, odom_msg: odom, pf_msg: odom):
        ...
        self.pose = [pf_msg.pose.pose.position.x, pf_msg.pose.pose.position.y, euler_from_quaternion(pf_msg.pose.pose.orientation), pf_msg.header.stamp]
        ...
        pf_values_list = [pf_msg.pose.pose.position.x, pf_msg.pose.pose.position.y, euler_from_quaternion(pf_msg.pose.pose.orientation)]
