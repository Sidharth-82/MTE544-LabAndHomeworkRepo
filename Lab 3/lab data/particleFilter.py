...
class particleFilter(Node):
    ...
    def initializeParticleFilter(self, x, y, th):
        ...
        # Generate particles around the initial pose (x, y, th) with Gaussian noise
        self.particlePoses = np.zeros((numParticles, 3))
    ...
    def resample(self, laser_scan, mapUtilInstance):
        ...
        sampled_indices = np.random.choice(len(self.particles), size=self.numParticles, p=particles_weights)
